/**
 * data: 2017-12-12 13:07:14
 * author: yuechenglei
 * describe: 
 */
import L from 'leaflet'
import { canvasOverlay } from 'leafletjs-canvas-overlay'
// const canvasOverlay = require('leafletjs-canvas-overlay');
// import { canvasOverlay } from './L.CanvasOverlay.js'
import * as svgL from 'leaflet-d3-svg-overlay'
import $ from 'jquery'
// import * as d3 from 'd3'

// require('leafletjs-canvas-overlay')
...
export default class {
  ...
  updateSpatialTemporalFilteredData(data) {
    this.updateData(data);
  }
  updateArrShow(arrShow) {
  ...
  updateFilterShow(filterTrajShow) {
